...
class QLearning(AgentBaseClass):
	...
	def __init__(self, config_filename, o_space, a_space):
		...
		#opt = C.learners.sgd(self._q.parameters, C.learners.learning_rate_schedule(self._parameters.initial_eta, C.learners.UnitType.sample))
		#opt = C.learners.adadelta(self._q.parameters)
